...
def initializeTargetModel(dataset,num_epoch,dataFolderPath= './data/',modelFolderPath = './model/',classifierType = 'cnn', maskConfidences=False):
   ...
   np.savez(attackerModelDataPath + '/targetModelData_dropout_smoothing.npz', attackModelDataTarget, attackModelLabelsTarget)
   np.savez(modelPath + '/targetModel_dropout_smoothing.npz', *lasagne.layers.get_all_param_values(targetModelToStore))
...
def initializeShadowModel(dataset,num_epoch,dataFolderPath= './data/',modelFolderPath = './model/',classifierType = 'cnn', maskConfidences=False):
   ...
   np.savez(attackerModelDataPath + '/shadowModelData_dropout_smoothing.npz', attackModelDataShadow, attackModelLabelsShadow)
   np.savez(modelPath + '/shadowModel_dropout_smoothing.npz', *lasagne.layers.get_all_param_values(shadowModelToStore))
...
def generateAttackData(dataset, classifierType, dataFolderPath ,pathToLoadData ,num_epoch ,preprocessData ,trainTargetModel ,trainShadowModel,topX=3):
   ...
   if(trainTargetModel):  
       ...
       targetX, targetY = load_data(attackerModelDataPath + '/targetModelData_dropout_smoothing.npz')
   ...
   if(trainShadowModel):  
       ...
       shadowX, shadowY = load_data(attackerModelDataPath + '/shadowModelData_dropout_smoothing.npz')
